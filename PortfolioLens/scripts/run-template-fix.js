/**
 * Script to run the mapping templates parameter fix
 * This script applies the migration to fix the RPC function parameters
 */
...
const migrationFile = '../src/db/migrations/030_fix_template_rpc_parameters.sql';
...
// Main function
async function main() {
  console.log('=== Mapping Templates Parameter Fix ===');
  ...
  try {
    ...
    // Test get_mapping_templates function
