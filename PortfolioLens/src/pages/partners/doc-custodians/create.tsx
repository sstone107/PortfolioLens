...
export const DocCustodianCreate: React.FC<IResourceComponentsProps> = () => {
  const navigate = useNavigate();
  
  const { saveButtonProps, register, formState: { errors } } = useForm<IDocCustodianFormData>({
    refineCoreProps: {
  ...
  return (
    <Create 
      title="Create Document Custodian" 
...
export default DocCustodianCreate;