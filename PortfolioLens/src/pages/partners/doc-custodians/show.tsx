...
export const DocCustodianShow: React.FC<IResourceComponentsProps> = () => {
  ...
  if (!record) {
    return <div>Document Custodian not found</div>;
  }

  return (
    <Show 
      title="Document Custodian Details" 
...
export default DocCustodianShow;